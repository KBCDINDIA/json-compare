...
function App() {
  ...
  return (
    <div className="min-h-screen bg-bg text-ink">
              ...
              <div className="flex items-center justify-between flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <PDFDownloadLink
                    ...
                    fileName={buildPdfFilename(result.sorted)}
      ...
      <footer className="border-t border-edge bg-surface mt-8">
        <div className="max-w-6xl mx-auto px-6 py-5 flex flex-col items-center gap-1">
          ...
          <div className="text-xs text-ink-muted">
            Internal Data Comparison System
          </div>
          <div className="text-xs text-ink-muted/60 mt-1">
            Generated by JSON Compare • Everything runs locally in your browser
